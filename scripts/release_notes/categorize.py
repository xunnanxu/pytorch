...
from classifier import CommitClassifier, CategoryConfig, XLMR_BASE, get_author_map, CommitClassifierInputs
import common
import torch
...
class Categorizer:
    def __init__(self, path, category='Uncategorized', use_classifier:bool = False):
        ...
        if use_classifier:
            ...
            self.classifier = CommitClassifier(XLMR_BASE, author_map, classifier_config).to(device)
